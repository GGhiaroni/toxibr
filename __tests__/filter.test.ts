...
describe('game names — FPS / Battle Royale', () => {
  const games = [
    'Counter-Strike 2', 'CS2', 'CSGO', 'Counter-Strike Global Offensive',
    'Valorant', 'Fortnite', 'PUBG', 'PlayerUnknown Battlegrounds',
    'Apex Legends', 'Overwatch 2', 'Call of Duty', 'Warzone', 'Warzone 2',
    'Rainbow Six Siege', 'Free Fire', 'Free Fire Max',
    'Halo Infinite', 'Halo 3', 'Team Fortress 2', 'Titanfall 2',
    'Splitgate', 'Hunt Showdown', 'Escape from Tarkov',
    'Paladins', 'Quake Champions', 'Doom Eternal', 'Doom 2016',
    'Bulletstorm', 'Left 4 Dead 2', 'Back 4 Blood',
    'Deep Rock Galactic', 'Gunfire Reborn', 'Remnant 2',
    'Risk of Rain 2', 'Killing Floor 2', 'Insurgency Sandstorm',
    'Battlefield 2042', 'Battlefield V', 'Battlefield 1',
    'Call of Duty Modern Warfare', 'Call of Duty Black Ops',
    'Destiny 2', 'Outriders', 'The Division 2',
  ];
...
describe('game names — MOBA / RPG', () => {
  const games = [
    ...
    'Diablo IV', 'Diablo Immortal', 'Diablo 3',
    'Path of Exile', 'Path of Exile 2',
    'Lost Ark', 'World of Warcraft', 'WoW', 'WoW Classic',
    'Final Fantasy XIV', 'Final Fantasy XVI', 'FFXIV', 'FF14',
    'Final Fantasy VII Remake', 'Final Fantasy VII Rebirth',
    'Black Desert Online', 'Elder Scrolls Online', 'ESO',
    'Guild Wars 2', 'GW2', 'RuneScape', 'Old School RuneScape', 'OSRS',
    'MapleStory', 'Ragnarok Online', 'Lineage W',
    'Smite', 'Heroes of the Storm', 'HOTS',
    'Battlerite', 'Predecessor',
    'Frostpunk 2', 'Pillars of Eternity',
    'Baldurs Gate 3', 'BG3',
    'Divinity Original Sin 2', 'Dragon Age Origins', 'Dragon Age Inquisition',
    'Vampire Survivors', 'Torchlight Infinite',
...
describe('game names — Aventura / Ação', () => {
  const games = [
    'GTA V', 'GTA 6', 'Grand Theft Auto V',
    'Red Dead Redemption 2', 'RDR2',
    'Elden Ring', 'Elden Ring Shadow of the Erdtree',
    'God of War Ragnarok', 'God of War',
    'The Last of Us', 'The Last of Us Part 2',
    'Resident Evil 4', 'Resident Evil Village', 'Resident Evil 2',
    'Hogwarts Legacy', 'Zelda Tears of the Kingdom', 'TotK', 'BotW',
    'Minecraft', 'Minecraft Bedrock', 'Roblox',
    'Cyberpunk 2077', 'Cyberpunk Phantom Liberty',
    'The Witcher 3', 'The Witcher 3 Wild Hunt',
    'Dark Souls', 'Dark Souls 3', 'Dark Souls Remastered',
    'Bloodborne', 'Sekiro', 'Sekiro Shadows Die Twice',
    'Nioh 2', 'Nioh',
    'Devil May Cry 5', 'Devil May Cry', 'DMC5',
    'Bayonetta 3', 'Bayonetta',
    'Hades', 'Hades 2',
    'Dead Cells', 'Hollow Knight', 'Hollow Knight Silksong',
    'Celeste', 'Shovel Knight', 'Cuphead',
    'Ori and the Blind Forest', 'Ori and the Will of the Wisps',
    'Metroid Dread', 'Metroid Prime',
    'Spider-Man 2', 'Spider-Man Miles Morales',
    ...
    'Hitman 3', 'Hitman World of Assassination', 'Hitman',
    'Watch Dogs Legion', 'Watch Dogs 2',
    'Mafia Definitive Edition', 'Mafia 3',
    'Far Cry 6', 'Far Cry 5', 'Far Cry New Dawn',
    'Just Cause 4', 'Saints Row',
    'Control', 'Alan Wake 2', 'Alan Wake',
    'Death Stranding', 'Death Stranding Directors Cut',
    'Dying Light 2', 'Dying Light',
    'Ghostwire Tokyo', 'Deathloop',
    'Mortal Kombat', 'Mortal Kombat 11', 'MK11', 'Mortal Kombat 1',
    'Killer Instinct',
  ];
...
describe('game names — Horror / Suspense', () => {
  const games = [
    'Phasmophobia', 'Outlast', 'Outlast 2', 'Outlast Trials',
    'Dead by Daylight', 'Silent Hill 2', 'Silent Hill',
    'Amnesia The Dark Descent', 'Amnesia Rebirth',
    'Little Nightmares', 'Little Nightmares 2',
    'Dread Templar', 'Visage', 'Layers of Fear',
...
describe('game names — Esportes / Corrida', () => {
  const games = [
    'EA FC 25', 'EA FC 24', 'FIFA 23', 'FIFA 22',
    'eFootball 2024', 'eFootball', 'PES 2021',
    'NBA 2K24', 'NBA 2K23', 'NBA 2K25', 'NBA Live',
    'Rocket League', 'Gran Turismo 7', 'Gran Turismo',
    'Forza Horizon 5', 'Forza Horizon 4', 'Forza Motorsport',
    'F1 23', 'F1 22', 'WRC Generations', 'Dirt Rally 2',
    'Need for Speed Heat', 'Need for Speed Unbound',
    'Wreckfest', 'Riders Republic',
    'Tony Hawk Pro Skater', 'Tony Hawk',
    'SSX', 'SSX 3', 'NFL Madden 24', 'PGA Tour 2K23',
    'WWE 2K24', 'UFC 5',
  ];
...
describe('game names — Estratégia / Simulação', () => {
  const games = [
    'Civilization 6', 'Civilization V', 'Civ 6',
    'Age of Empires 4', 'Age of Empires 2', 'AoE4',
    'StarCraft 2', 'Warcraft 3', 'Warcraft Reforged',
    'Command and Conquer', 'Red Alert 3',
    'Factorio', 'Cities Skylines', 'Cities Skylines 2',
    ...
    'Victoria 3', 'Stellaris',
    'Total War Warhammer 3', 'Total War Three Kingdoms',
    'XCOM 2', 'XCOM Enemy Unknown', 'Phoenix Point',
...
describe('game names — Survival / Sandbox', () => {
  const games = [
    'Terraria', 'Stardew Valley', 'Animal Crossing',
    'Animal Crossing New Horizons',
    'Valheim', 'Rust', 'DayZ', 'Ark Survival Evolved', 'Ark Survival Ascended',
    '7 Days to Die', 'Subnautica Below Zero',
    'The Forest', 'Green Hell', 'Conan Exiles',
    'Raft', 'No Mans Sky', 'Satisfactory', 'Astroneer',
    'The Long Dark', 'Stranded Deep', 'Icarus',
    'Minecraft Survival', 'Minecraft Creative',
    'Palworld', 'Enshrouded', 'Smalland',
  ];
...
describe('game names — Luta / Fighting', () => {
  const games = [
    'Tekken 8', 'Tekken 7', 'Tekken',
    'Street Fighter 6', 'Street Fighter V', 'SF6',
    'Mortal Kombat 11', 'Mortal Kombat 1',
    'Killer Instinct', 'Killer Instinct Season 3',
    'Guilty Gear Strive', 'Guilty Gear Xrd',
    'Dragon Ball FighterZ', 'Dragon Ball Sparking Zero',
    'BlazBlue Cross Tag Battle',
    'King of Fighters 15', 'KOF15',
    'Samurai Shodown', 'Injustice 2',
    'Marvel vs Capcom', 'Soul Calibur 6',
    'Skullgirls', 'Under Night In-Birth',
    'DNF Duel', 'Granblue Fantasy Versus',
    'Multiversus', 'Brawlhalla',
  ];
...
describe('game names — Party / Casual / Indie', () => {
  const games = [
    'Among Us', 'Fall Guys', 'Stumble Guys', 'Gang Beasts',
    'Overcooked', 'Overcooked 2', 'Untitled Goose Game',
    'Jackbox Party Pack', 'Human Fall Flat', 'Moving Out', 'Tools Up',
    'Pummel Party', 'Ultimate Chicken Horse',
    'Cuphead The Delicious Last Course',
    'Hollow Knight', 'Celeste', 'Ori',
    'Psychonauts 2', 'A Hat in Time', 'Yooka-Laylee',
    'Ratchet and Clank', 'Sackboy A Big Adventure',
    'Kirby Forgotten Land', 'Donkey Kong Country',
    'Mega Man 11', 'Cave Story', 'Owlboy',
    'Spelunky', 'Spelunky 2',
...
describe('game names — colisões potenciais (issue #64)', () => {
  ...
  describe('aliases e abreviações comuns de jogos', () => {
    const aliases = [
      'CS', 'CS2', 'CSGO', 'LoL', 'WoW', 'DOTA', 'GTA', 'RDR2',
      'FFXIV', 'FF14', 'FF16', 'BotW', 'TotK', 'MK11', 'SF6', 'DMC5',
      'HOTS', 'GW2', 'OSRS', 'FNAF', 'AoE4', 'CK3', 'EU4', 'HOI4',
      'BG3', 'KOF15', 'ESO', 'BF2042',
    ];
